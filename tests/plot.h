...
public:
    ...
    virtual void
    set_values(SolvingType RES, Method MTD, double &S, double &V, double &K, double &r, double &kappa, double &theta,
               double &sigma, double &rho, double &T, int &M, double &delta_S, double &delta_sigma) {};
    virtual void show() = 0;
